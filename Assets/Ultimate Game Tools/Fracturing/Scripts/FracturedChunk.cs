...
public class FracturedChunk : MonoBehaviour
{
    ...
    public void UpdatePreviewDecompositionPosition()
    {
        ...
        //FIXME: JoeHack
        Vector3 zzz = transform.localPosition;
        zzz.x = m_v3InitialLocalPosition.x+ (v3RadialVector * (PreviewDecompositionValue * fModulateRadius * fMultiplyRadius)).x;
        zzz.y = m_v3InitialLocalPosition.y+ (v3RadialVector * (PreviewDecompositionValue * fModulateRadius * fMultiplyRadius)).y;
        zzz.z = m_v3InitialLocalPosition.z; //+ (v3RadialVector * (PreviewDecompositionValue * fModulateRadius * fMultiplyRadius)).z;
        transform.localPosition = zzz;
